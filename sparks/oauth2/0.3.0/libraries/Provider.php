...
abstract class OAuth2_Provider
{
	...
	public function __construct(array $options = array())
	{
		if ( ! $this->name)
		{
			...
			$this->name = ucfirst(substr(get_class($this), strlen('OAuth2_Provider_')));
		}
		...
		// XXX GAB edit
		$this->redirect_uri = isset($options['callback']) ? $options['callback'] : site_url(get_instance()->uri->uri_string());
