...
$config['bootstrap_files'] = array(
	'bootstrap/_admin-bootstrap.less' => array(
		'bootstrap/_admin-bootstrap.less',
		'bootstrap/_admin-variables.less',
		'bootstrap/_admin-boxes.less',
		'bootstrap/_admin-extend.less',
		'bootstrap/_admin-responsive.less',
	),
	'bootstrap/_login-bootstrap.less' => array(
...
$config['groups']['jquery'] = array(
	'js' => array(
		array('http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.js', 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js', TRUE, FALSE)
	)
);
